...
- `.Codex/glossary.md` — project terminology (T/index, R/rank, layer, workspace, etc.)
...
4. Defer all git mechanics to `.Codex/process.md`. Never narrate branch operations to user.
...
- To implement: ask Codex in a new turn "implement the plan in `docs/plans/<workspace-id>-plan.md`"
