/**
 * Leg-equality strip zoom: T∈[9.42, 9.46], one-page plot data.
 * Same metric as remainder-leg-equality-heatmap.mjs.
 *
 * Progress: stderr every 25 T-rows — watch with the terminal or
 *   tail -f of the process log.
 *
 * Run from web/: npx vite-node scripts/remainder-leg-equality-heatmap-zoom.mjs
 */
...
const N_SIGMA = 2500;
const EPS = 1e-18;
const STEM = "leg_equality_strip_9p42_9p46";
