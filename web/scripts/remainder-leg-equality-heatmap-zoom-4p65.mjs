/**
 * Leg-equality strip zoom: T∈[4.65, 4.80].
 * Same metric as remainder-leg-equality-heatmap.mjs.
 *
 * Run from web/: npx vite-node scripts/remainder-leg-equality-heatmap-zoom-4p65.mjs
 */
...
const N_SIGMA = 2500;
const EPS = 1e-18;
const STEM = "leg_equality_strip_4p65_4p80";
