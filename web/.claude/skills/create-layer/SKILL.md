...
- `.claude/glossary.md` — project terminology (T/index, R/rank, layer, workspace, link, joint, bisector, etc.)
...
4. Never narrate branch operations to user. Defer all git mechanics to `.claude/process.md`.
