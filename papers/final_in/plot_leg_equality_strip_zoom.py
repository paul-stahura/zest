#!/usr/bin/env python3
"""
Leg-equality strip T∈[9.42, 9.46] — same style as leg_equality_strip_0_20,
sized to one letter page (~11 in tall).
"""
...
ZEST = HERE.parents[2]
STEM = "leg_equality_strip_9p42_9p46"
...
# One letter page: ~3.5 in wide plot + colorbar, ~10 in tall axes.
FIG_W = 3.5
FIG_H = 10.0
FLOOR = 1e-16
...
def main() -> None:
    ...
    # Fill the page height; do not force the 1:30 aspect of the long strip.
    ax.set_aspect("auto")
    ax.set_title(
