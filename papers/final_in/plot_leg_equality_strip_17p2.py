#!/usr/bin/env python3
"""Leg-equality strip T∈[17.2, 17.6] — one page; zeros @ σ=1/2; no champions."""
...
ZEST = HERE.parents[2]
STEM = "leg_equality_strip_17p2_17p6"
...
FIG_W, FIG_H, FLOOR = 3.5, 10.0, 1e-16
...
def main() -> None:
    ...
    fig, ax = plt.subplots(figsize=(FIG_W + 1.1, FIG_H))
